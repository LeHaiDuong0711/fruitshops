		...
		<div class="card">
			...
			<div class="card-body">
				<form action="<?php
								if ($firstNameErr != "" || $lastNameErr != "" || $usernameErr != "" || $passwordErr != "" || $passwordAgainErr != "" || $phoneErr != "" || $emailErr != "") {
									echo "index.php?act=register";
								} else {
									echo "index.php?act=register_action";
								}
			...
			<div class="card-footer">
				...
				<div class="d-flex justify-content-center links">
					Have an account?<a href="index.php?act=login">Sing In</a>
				</div>
				<div class="d-flex justify-content-center links">
					<a href="index.php?act=changePassword">Change password?</a>
				</div>
				<div class="d-flex justify-content-center links">
					<a href="index.php?act=forgotPassword">Forgot your password?</a>
				</div>
			</div>
		</div>
	</div>
