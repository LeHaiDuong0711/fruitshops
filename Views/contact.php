...
if (isset($_POST["submit"])) {
	...
	if ($error == '') {
		...
		$mail->Password = 'zmnafekqyizkwrhb'; //Phplytest20@php					//Sets SMTP password
		...
		$mail->Body = "Email: " . $_POST["email"] . "Message" . $_POST["message"];				//An HTML or plain text message body
...
<section class="sectionContact">
	...
	<div class="row">
		<div class="col-lg-6 col-sm-12 info">
			<div class="col-inner">
				<h4><span>Liên Hệ Với Hidden Fruits Shop</span></h3>
					<ul>
						<li><Strong>Địa Chỉ: </Strong> 12 võ hoành, Phường Phú Thọ Hòa, Quận Tân Phú, TP.HCM</li>
						<li><Strong>Hotline: </Strong> 0346.098.854</li>
						<li><Strong>Email: </Strong> hiddenfruitsshop@gmail.com</li>
						<li>
		...
		<div class="col-lg-6 col-sm-12 sendInfo">
			...
			<form method="post" class="border border-success p-3">
				<h4>Liên Hệ Tư Vấn Mua Hàng</h1>
					...
					<div>
						<input class="form-control mt-3" type="text" name="message" id="" placeholder="Nội dung cần tư vấn...">
					</div>
					<div>
